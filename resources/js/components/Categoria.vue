                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-1">
                                <button type="submit" @click="listarCategoria(1,buscar,criterio)" class="btn btn-success active"><i class="fa fa-search"></i> Buscar</button>
                            </div>
                            
                            <div class="col-md-1">
                                <button type="button" @click="abrirModal('categoria','registrar')" class="btn btn-danger active" >
