                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-1 form-control-label text-left" for="text-input">Nota</label>
                                    <div class="col-md-9">
                                        <!--<input type="text" v-model="nota_corta" class="form-control" placeholder="Ingrese una nota."> -->
                                        <textarea class="form-control rounded-0" v-model="nota_corta" rows="3"></textarea>
                                    </div>
                                </div>
        ...
        methods : {
            listarPersona (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arrayPersona = respuesta.clientes.data;
            ...
            validarPersona(){
                ...
                if(!this.nombre) this.errorMostrarMsjPersona.push("El nombre de la categoria no puede estar vacío.");
