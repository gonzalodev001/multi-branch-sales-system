                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-md-3">
                                        ...
                                        <input type="date" v-model="fechai" @keyup.enter="listarIngresoFecha(1,fechai,fechaf)" class="form-control" placeholder="Texto a buscar">
                                        
                                    
                                </div>
                                <div class="col-md-3">
                                    <label>Fecha Final</label>
                                    <input type="date" v-model="fechaf" @keyup.enter="listarIngresoFecha(1,fechai,fechaf)" class="form-control" placeholder="Texto a buscar">
                                </div>
                                
                                <div class="col-md-1">
                                    <button type="submit" @click="listarIngresoFecha(1,fechai,fechaf)" class="btn btn-success active"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            ...
                            <div class="form-control row">
                                ...
                                <div class="col-md-3">
                                    <label for="" v-text="total_ingresos">  </label>
                                </div>
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            listarIngresoFecha (page,fechai,fechaf){
                if(this.validarIngresoRporte()){
                    return;
                }
                let me = this;
                var url = '/ingreso/reporte?page=' + page + '&fechai='+ fechai + '&fechaf='+ fechaf;
                axios.get(url).then(function (response) {
                    var respuesta = response.data;
                    me.arrayIngreso = respuesta.ingresos.data;
                    me.pagination = respuesta.pagination;
                    me.total_ingresos = respuesta.total_ingresos;
            ...
            validarIngresoRporte(){
                let me = this;

                if(me.fechaf==null || me.fechai==null || me.fechaf=="" || me.fechai==""){
                    swal({
                            type: 'error',
                            title: 'Error...',
                            text: 'Los campos de las fechas no pueden estar vacios!'
                        });
                }
            },
            validarVenta(){
